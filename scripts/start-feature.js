 ...
 * This is typically invoked by the Architect agent at the start of a feature.
 */
...
|-------|----------|--------|
| Architect | [architect.md](./architect.md) | Pending |
...
`;
  ...
  console.log(`\n📋 Next Steps:`);
  console.log(`   1. Invoke @architect with your feature request`);
  console.log(`   2. Architect will create ADRs and system design`);
  console.log(`   3. Follow the cascade: Architect → Designer → Coder → Tester → Documentor → Closer`);
  console.log(`\n💡 Example prompt for Architect:`);
  console.log(`   @architect I want to build ${rawFeatureName}. Help me design the system architecture.`);
  console.log('');
